package com.cucumber.step_definationGmailLogin;
...
public class GmailLogin_featuedefinations {
	...
	public void user_verifies_the_username_text_box_display_and_enter_username() throws Throwable{
		
		Assert.assertTrue(driver.findElement(By.id("identifierId")).isDisplayed());
		driver.findElement(By.id("identifierId")).click();
		driver.findElement(By.id("identifierId")).sendKeys("onlinedatauser10");
	}
	...
	public void user_verifies_the_password_text_box_display_and_enter_password() throws Throwable{
		
		Assert.assertTrue(driver.findElement(By.id("identifierId")).isDisplayed());
		
		driver.findElement(By.id("identifierId")).sendKeys("Gkgs@1992");
	}
